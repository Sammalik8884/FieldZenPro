...
namespace MytechERP.Application.Interfaces
{
    public interface IAuthService
    {
        ...
        Task<string> UpdateUserAsync(string userId, UpdateUserRequest request, string currentAdminTenantId);
        Task<string> DeleteUserAsync(string userId, string currentAdminTenantId);
    }
}
