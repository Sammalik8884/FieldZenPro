$files = "about.html", "blog.html", "careers.html", "gdpr.html", "privacy.html", "security.html", "terms.html", "blog-automate-invoicing.html", "blog-best-fm-software-2026.html", "blog-digital-checklists-fm.html", "blog-digital-work-orders.html", "blog-erp-vs-cmms.html"
$newCSS = @"
<style>
...
foreach ($file in $files) {
    if (Test-Path "public\$file") {
        $content = Get-Content -Raw -Path "public\$file"
        $content = $content -replace '(?s)<style>.*?</style>', $newCSS
        Set-Content -Path "public\$file" -Value $content
