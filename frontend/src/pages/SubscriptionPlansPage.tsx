...
export const SubscriptionPlansPage: React.FC = () => {
 ...
 >
 <h1 className="mb-2 md:mb-3 text-3xl font-extrabold tracking-tight lg:text-4xl">
 ...
 className="mb-8 overflow-hidden rounded-2xl border border-primary/20 bg-primary/5 p-4 md:p-6"
 >
 ...
 className="relative flex flex-col overflow-hidden rounded-2xl border bg-card p-6 shadow-sm transition-all hover:shadow-md sm:p-8"
 >
 {index === 1 && (
 ...
 <span className="text-4xl font-extrabold tracking-tight">${plan.monthlyPrice}</span>
 ...
 className={`group relative flex py-3 md:py-3.5 w-full items-center justify-center overflow-hidden rounded-xl font-bold tracking-wide text-white transition-all ${
 ...
 <div className="mt-8 text-center text-sm tracking-wide flex items-center justify-center gap-2 text-muted-foreground">
