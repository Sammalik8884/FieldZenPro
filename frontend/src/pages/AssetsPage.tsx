...
export const AssetsPage = () => {
 ...
 <div className="mt-3 p-3 bg-muted border border-primary/20 rounded-lg text-xs text-muted-foreground max-w-xl">
 ...
 className="bg-card border border-border text-foreground px-4 py-2 rounded-lg font-medium hover:bg-secondary/60 transition-all cursor-pointer flex items-center space-x-2"
 title="Download the required template format"
 >
 <Box className="h-5 w-5" />
 <span>Download Template</span>
 </button>
 <label className="bg-card border border-border text-foreground px-4 py-2 rounded-lg font-medium hover:bg-secondary/60 transition-all cursor-pointer flex items-center space-x-2" title="File must exactly match the template format">
