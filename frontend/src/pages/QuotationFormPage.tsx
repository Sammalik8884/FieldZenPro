...
export const QuotationFormPage = () => {
 ...
 <h3 className="text-lg font-semibold text-foreground border-b border-border pb-2 mb-4">Header Details</h3>
 ...
 <h3 className="text-lg font-semibold text-foreground border-b border-border pb-2 mb-4">Taxes & Adjustments</h3>
