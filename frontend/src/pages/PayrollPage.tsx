...
export const PayrollPage = () => {
 ...
 className="bg-secondary/80 text-foreground px-4 py-2.5 rounded-xl flex items-center gap-2 hover:bg-secondary transition-all font-medium border border-border hover:border-emerald-500/50 hover:shadow-lg "
 >
 ...
 className="bg-secondary/80 text-foreground px-4 py-2.5 rounded-xl flex items-center gap-2 hover:bg-secondary transition-all font-medium border border-border hover:border-blue-500/50 hover:shadow-lg "
 >
 ...
 className="bg-primary text-primary-foreground px-5 py-2.5 rounded-xl flex items-center gap-2 hover:bg-primary/90 transition-all font-semibold hover:-translate-y-0.5 active:scale-95 shadow-sm"
 >
 ...
 {/* Stat Card 1 */}
 <div className="bg-card border border-border rounded-xl p-6 relative overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
 ...
 className="w-full bg-muted border-none rounded-full pl-11 pr-4 py-2.5 text-sm outline-none focus:bg-card focus:shadow-md transition-all text-foreground"
 />
 </div>
 </div>
 ...
 {loading ? (
 <div className="absolute inset-0 flex flex-col items-center justify-center bg-muted z-50">
 ...
 <th className="px-6 py-5 font-semibold text-right text-muted-foreground">Bonuses</th>
 <th className="px-6 py-5 font-semibold text-right text-muted-foreground">Penalties</th>
 <th className="px-6 py-5 font-semibold text-right text-muted-foreground">Net Pay</th>
 ...
 <tr key={ps.id} className="hover:bg-muted transition-colors group">
 ...
 <div className="px-2.5 py-1 bg-secondary rounded-md border border-border">
 ...
 <td className="px-6 py-4">
 <div className="inline-flex px-3 py-1 bg-secondary rounded border border-border text-xs font-mono text-muted-foreground">
 {p.userId}
 </div>
 </td>
 <td className="px-6 py-4 text-right">
 ...
 <button onClick={() => setShowGenerateModal(false)} className="bg-white/5 hover:bg-muted p-2 rounded-full transition-colors text-muted-foreground">
 <X className="h-5 w-5" />
 </button>
 </div>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 border border-border p-4 rounded-2xl bg-white/5">
 <div>
 ...
 <button onClick={() => setShowProfileModal(false)} className="bg-white/5 hover:bg-muted p-2 rounded-full transition-colors text-muted-foreground">
 <X className="h-5 w-5" />
 </button>
 </div>
 ...
 <button onClick={() => setShowEntryModal(false)} className="bg-white/5 hover:bg-muted p-2 rounded-full transition-colors text-muted-foreground">
 <X className="h-5 w-5" />
 </button>
 </div>
 ...
 <div className="bg-muted border border-border rounded-xl p-4 flex gap-3 items-start mt-2">
