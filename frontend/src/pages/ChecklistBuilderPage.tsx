...
export const ChecklistBuilderPage = () => {
 ...
 {/* ── Sidebar: Categories ──────────────────────────────── */}
 <div className="col-span-1 border border-border rounded-2xl bg-card overflow-hidden flex flex-col shadow-lg" style={{ height: "calc(100vh - 250px)" }}>
 <div className="p-4 border-b border-border bg-muted font-medium flex items-center gap-2 text-sm">
 ...
 <div className="border border-border rounded-2xl bg-card overflow-hidden flex-1 flex flex-col shadow-lg">
 {/* Builder toolbar */}
 ...
 return (
 <div key={q.id} className="bg-background/40 border border-border rounded-xl p-5 relative group hover:border-border transition-all">
 {/* Type badge */}
 <div className={`absolute top-3 right-3 flex items-center gap-1.5 text-xs font-medium ${meta.color} bg-muted px-2.5 py-1 rounded-full`}>
