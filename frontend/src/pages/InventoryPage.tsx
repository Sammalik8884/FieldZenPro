...
export const InventoryPage = () => {
 ...
 <div className="col-span-1 border border-border rounded-2xl bg-card overflow-hidden flex flex-col h-[calc(100vh-250px)]">
 <div className="p-4 border-b border-border bg-muted font-medium space-y-3">
 ...
 <div className="p-2 border-t border-border flex justify-between items-center text-xs text-muted-foreground bg-muted">
 <button
 disabled={page === 1}
 ...
 {/* Main Stock Table */}
 <div className="col-span-3 border border-border rounded-2xl bg-card overflow-hidden flex flex-col h-[calc(100vh-250px)]">
 ...
 warehouses.map((w) => (
 <tr key={w.id} className="hover:bg-muted transition-colors">
 <td className="px-6 py-4 font-medium text-foreground">
 {w.name}
 </td>
 <td className="px-6 py-4 text-muted-foreground">
