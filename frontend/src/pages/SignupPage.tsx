...
import { Briefcase, KeyRound, Mail, User, Building, AlertCircle, Loader2, Phone, Eye, EyeOff } from "lucide-react";
...
export const SignupPage = () => {
 ...
 <div className="bg-card border border-border rounded-2xl p-8 shadow-md relative overflow-hidden">
 ...
 className="w-full bg-background border border-border rounded-xl pl-10 pr-10 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm shadow-inner"
 placeholder="••••••••"
 />
 <button
 type="button"
