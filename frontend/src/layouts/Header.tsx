...
export const Header = ({ onMenuClick }: HeaderProps) => {
    ...
    return (
        <header className="h-16 border-b border-border bg-card sticky top-0 z-40 flex items-center justify-center">
            <div className="w-full max-w-7xl px-4 md:px-8 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2 md:space-x-5">
                    ...
                    <div className="relative" ref={notifRef}>
                        ...
                        {showNotifDropdown && (
                            <div className="absolute right-0 top-full mt-2 w-80 md:w-96 bg-card border border-border rounded-xl shadow-lg overflow-hidden z-50 flex flex-col max-h-[400px]">
